...
func main() {
	...
	//stateless_chart_key_values([]int{13,14}, "key_vals_2675000.png", 2675000, 4)
	//stateless_chart_key_values([]int{10,11}, "c_key_vals_2675000.png", 2675000, 4)
    //stateless_chart_key_values([]int{6, 7}, "mask_hash_2675000.png", 2675000, 4)
	//stateless_chart_key_values([]int{1, 2}, "c_mask_hash_2675000.png", 2675000, 4)
